...
export const commands: Commands = {
  ...
  select_automation_driver: {
    description:
      'Selects the automation driver used for user-visible actions (click, fill, navigate, keys). "puppeteer" (default) performs actions via Puppeteer. "wdio" performs actions via WebdriverIO attached to the same browser; it requires the optional "webdriverio" dependency and a browser with a TCP debugging endpoint (start the server with --automation-driver wdio or --browser-url). Diagnostics such as traces, network, console and screenshots always use Chrome DevTools Protocol.',
    category: 'Navigation automation',
    args: {
      driver: {
        name: 'driver',
        type: 'string',
        description: 'The automation driver to use for subsequent actions.',
        required: true,
        enum: ['puppeteer', 'wdio'],
      },
    },
